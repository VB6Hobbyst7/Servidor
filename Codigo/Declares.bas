...
Public CuentaRegresivaTimer As Integer
...
Public Const iBalsa = 547

' Embarcaciones ciudas
Public Const iBarcaCiuda = 395
Public Const iBarcaCiudaAtacable = 395
Public Const iGaleraCiuda = 397
Public Const iGaleraCiudaAtacable = 397
Public Const iGaleonCiuda = 399
Public Const iGaleonCiudaAtacable = 399

' Embarcaciones reales
Public Const iBarcaReal = 395
Public Const iBarcaRealAtacable = 395
Public Const iGaleraReal = 397
Public Const iGaleraRealAtacable = 397
Public Const iGaleonReal = 399
Public Const iGaleonRealAtacable = 399
...
' Embarcaciones caos
Public Const iBarcaCaos = 396
Public Const iGaleraCaos = 398
Public Const iGaleonCaos = 400



Public Const TIMER_ATTACK = 5
...
Public Const MAXATRIBUTOS As Byte = 42
Public Const MINATRIBUTOS As Byte = 6

Public Const ManualDeClan As Integer = 1075
...
Public Const SND_CRITICOM As Byte = 237
Public Const SND_APRENDERHECHIZO As Byte = 234
Public Const SND_MONTAR As Byte = 56
Public Const SND_DESMONTAR As Byte = 4
Public Const SND_LIBERAR_MONTURA As Byte = 57
Public Const SND_ALCANZO_EXPLOSION_HOMBRE As Byte = 157
Public Const SND_ALCANZO_EXPLOSION_MUJER As Byte = 72
'Public Const SND_CAMINA_CABALLO As Byte = 68
...
Public Const FONTTYPE_RETOS As String = "~220~220~220~1~1"
Public Const FONTTYPE_EXP As String = "~255~70~0~1~0"
...
Public Type ModRaza
    ...
    Armas As Single
    Magia As Single
    Proyectiles As Single
    ReduceMagia As Single
    EvitarGolpe As Single
End Type
'[/Pablo ToxicWaste]
...
Public Type UserFlags
    ...
    NpcMonturaIndex As Integer
    NpcMonturaNumero As Integer
    PuertoStart As Byte
    EmbarcacionIndex As Integer
    EmbarcacionPos As WorldPos
    Nadando As Boolean
    ...
    '[CDT 17-02-04]
    UltimoMensaje As Byte    'UltimoMensaje - 23'
    '[/CDT]
...
Public MultiplicadorEXP As Single
...
Public Hogares(1 To eCiudad.cLastCity - 1) As WorldPos
...
Public Const ROPA_CARCEL_ALTOS As Integer = 443
Public Const ROPA_CARCEL_BAJOS As Integer = 442
...
Public Const BALA_CANON As Integer = 1073
