...
If .Stats.MinSta = 0 And .Stats.MinHP > 0 Then
  Dim daño As Byte
  daño = RandomNumber(5, Porcentaje(.Stats.MaxHP, 8))
  .Stats.MinHP = .Stats.MinHP - daño
  Call WriteUpdateHP(UserIndex)
  Call WriteTooltip(UserIndex, .Pos.X, .Pos.Y, 0, "-" & daño)
  If RandomNumber(1, 5) = 1 Then
    Call WriteConsoleMsg(UserIndex, "Estás exhausto!!", FontTypeNames.FONTTYPE_FIGHT)
  End If
