...
'***************************************************
    ...
    With UserList(UserIndex)
        ...
        For i = 1 To LastUser
            If LenB(UserList(i).Name) <> 0 Then
                If UserList(i).flags.Privilegios And (PlayerType.User Or PlayerType.Consejero) Then
                    ...
                    Else
                    ListaUsers = ListaUsers & UserList(i).Name & "(Trabajando), "
                    End If
                   End If
            End If
        Next i
        ...
        End If
        Call WriteConsoleMsg(UserIndex, "Número de usuarios: " & NumUsers & vbCrLf & " Nombres: " & ListaUsers, FontTypeNames.FONTTYPE_INFO)
    End With
End Sub
