...
Public LloviendoConTormenta As Byte
...
Public Sub Encarcelar(ByVal UserIndex As Integer, ByVal Minutos As Long, Optional ByVal GmName As String = vbNullString)
        ...
        'Select Case Minutos
        '    Case 1 To 5
        '        Call WarpUserChar(UserIndex, 1, 221, 217, True)
        '    Case 6 To 10
        '        Call WarpUserChar(UserIndex, 1, 228, 217, True)
        '    Case 11 To 29
        '        Call WarpUserChar(UserIndex, 1, 235, 217, True)
        '    Case 30 To 59
        '        Call WarpUserChar(UserIndex, 1, 243, 217, True)
        '    Case Else ' Mas de 60
        '        Call WarpUserChar(UserIndex, 1, 250, 217, True)
        'End Select
